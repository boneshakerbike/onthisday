...
export const config = {
  ...
  matcher: [
    '/((?!login|story|archive|creative/archive|games|privacy|terms|api/auth|api/health|api/suggestions|api/stories|api/prompts|api/oura/callback|_next/static|_next/image|favicon.ico|icon.svg).*)',
  ],
};
